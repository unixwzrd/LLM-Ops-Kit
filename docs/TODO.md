...
- [ ] Upgrade both live hosts from the preserved operator-v1 runtime to `0.9.0b11`, reconcile template/profile changes, validate services, roll back once, and return to the candidate.
