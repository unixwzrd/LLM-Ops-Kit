...
- [x] Pass the dependency-complete source suite and precheck in the packaged UV environment. Commit `e5c1343` passed 146 tests and precheck on 2026-07-21.
...
- [x] Upgrade both live hosts to `0.9.0b14`, reconcile template/profile changes, validate services, roll back once, and return to the candidate. Live acceptance exposed and corrected ignored remote rollback selection, unsafe duplicate-install cleanup, and old-peer return behavior before the final coordinated b14 to b13 to b14 cycle passed.
